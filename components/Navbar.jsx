...
const Navbar = () => {
	...
	return (
		<div className="border-b rounded-sm shadow-md bg-[#fbfbfb] bg-opacity-60 sticky top-0 left-0 w-full z-50 h-16 backdrop-filter backdrop-blur-md ">
			<div className="flex items-center justify-between mx-auto px-4 py-2 max-w-5xl">
				<div className="flex">
					<Link href="/">
					...
					<ul className="flex text-lg font-mediuim items-center space-x-8 text-[#5f5f5f]">
						...
						<li className="text-[#fbfbfb]">
							<Link href="https://wa.link/2sxhcv">
								<a
									target="_blank"
									className=" bg-[#4D44B7] font-medium py-3 px-6 rounded-md md:hover:bg-[#fbfbfb] md:hover:text-[#4D44B7] border-2 border-[#4D44B7] transition-all duration-300 ease-out"
								>
									Contribute
								</a>
							</Link>
